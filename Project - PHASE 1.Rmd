...
clinics <- readOGR(dsn="data/clinics/chas-clinics-kml.kml", layer="MOH_CHAS_CLINICS")
```
```{r echo=FALSE, eval=TRUE, message=FALSE, warning=FALSE}
tm_shape(mpsz) + tm_polygons() +
...
hawker_centres <- readOGR(dsn="data/hawkercenters/hawker-centres-kml.kml", layer="HAWKERCENTRE")
```
